...
http_archive(
    ...
    url = "https://github.com/aspect-build/rules_js/releases/download/v2.5.0/rules_js-v2.1.2.tar.gz",
)
...
http_archive(
    ...
    url = "https://github.com/aspect-build/bazel-lib/releases/download/v2.21.1/bazel-lib-v2.10.0.tar.gz",
)
